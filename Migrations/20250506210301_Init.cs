    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RideVideos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RideVideos_UserProfile_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "UserProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comments_RideVideos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "RideVideos",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Likes_RideVideos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "RideVideos",
                        principalColumn: "Id");
                    table.ForeignKey(
